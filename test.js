...
мы слздали две переменные hello  и world и присвоили им значения и потом создали новую переменную greeting и в качестве значения 
...
newPost(firstPost)
                                                         ...
                                                         ОБРАБОТКА ОЩИБОК - (практика  test2.js -21)
...
если мы создадим массив, как объект и добавис самостоятельно свойство length, то обновляться оно не будет
